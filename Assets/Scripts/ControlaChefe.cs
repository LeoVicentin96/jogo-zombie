...
public class ControlaChefe : MonoBehaviour, IMatavel
{
    ...
    private void Update()
    {
        ...
        if (agente.hasPath == true) // se eu ja tenho um destino com NavMesh
        {
            bool estouPertoDoJogador = agente.remainingDistance <= agente.stoppingDistance; // distancia que falta pra terminar destino menor que distancia de parada
